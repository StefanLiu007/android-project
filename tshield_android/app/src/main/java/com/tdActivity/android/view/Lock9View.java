...
public class Lock9View extends ViewGroup {
	...
	public Drawable nodeOnSrc = getResources().getDrawable(R.drawable.lock);
	public int lineColor = getResources().getColor(R.color.lineColoring);
	public float lineWidth = 15;
	public float padding = 88; // 内边距
	public float spacing = 88; // 节点间隔距离
	...
	private void initFromAttributes(AttributeSet attrs, int defStyleAttr) {
		...
		nodeSrc = getResources().getDrawable(R.drawable.lock_back);
		nodeOnSrc = getNodeOnSrc();
