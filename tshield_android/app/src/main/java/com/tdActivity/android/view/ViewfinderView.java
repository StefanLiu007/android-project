...
//			canvas.drawText(getResources().getString(R.string.scan_text),(float) (frame.left + (float)TEXT_PADDING_LEFT *density) , (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
