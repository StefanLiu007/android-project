...
public class GesturePoint {
	...
	public void setPointState(int state) {
		...
		case Constant.POINT_STATE_NORMAL:
			this.image.setBackgroundResource(R.drawable.lock_back);
			break;
		case Constant.POINT_STATE_SELECTED:
			this.image.setBackgroundResource(R.drawable.lock);
			break;
		case Constant.POINT_STATE_WRONG:
			this.image.setBackgroundResource(R.drawable.error);
			break;
		case Constant.POINT_STATE_SUCESS:
			this.image.setBackgroundResource(R.drawable.sucess);
			break;
		default:
			break;
		}
