...
public class RoundProgressBar extends View {
	...
	//private static final int[] SECTION_COLORS={R.color.roundColor,R.color.roundcolorchange,R.color.thirdcolor};
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		// 获取自定义属性和默认值
		roundColor = getResources().getColor(R.color.roundProgressColor);
		roundProgressColor = getResources().getColor(R.color.roundColor);
