...
public class Problem {
	...
	public Problem(String problemContent, String problemLastTime) {
		super();
	...
	public Problem(String problemID, String userAccou, String problemContent, String problemLastTime,
			int problemAnswerNum) {
		super();
		this.problemID = problemID;
		this.userAccou = userAccou;
		this.problemContent = problemContent;
