...
public class AddUserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(flag){
			response.getWriter().println("<script type=\"text/javascript\">alert(\"添加成功\");location.href = \""+request.getContextPath()+"/ShowUserServlet.do\";</script>");
		}else{
			response.getWriter().println("<script type=\"text/javascript\">alert(\"添加失败\");location.href = \""+request.getContextPath()+"/ToAddUserServlet.do?USER_ACCOUNT=+\""+USER_ACCOUNT+";</script>");
		}
	}
