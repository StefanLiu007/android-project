...
public class AddExpertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String EXPERT_ACCOUNT = request.getParameter("EXPERT_ACCOUNT");
		...
		System.out.println("----"+ERTERT_ICON);
		...
		boolean flag = service.addExpert(expert);
		if(flag){
			response.getWriter().println("<script type=\"text/javascript\">alert(\"添加成功\");location.href = \""+request.getContextPath()+"/ShowExpertServlet.do\";</script>");
		}else{
			response.getWriter().println("<script type=\"text/javascript\">alert(\"添加失败\");location.href = \""+request.getContextPath()+"/ToAddExpertServlet.do?EXPERT_ACCOUNT=+\""+EXPERT_ACCOUNT+";</script>");
		}
	}
