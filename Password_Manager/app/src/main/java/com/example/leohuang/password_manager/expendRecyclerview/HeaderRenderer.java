package com.example.leohuang.password_manager.expendRecyclerview;
...
public class HeaderRenderer {
   ...
   * allocating new RDimensionCalculator.javaDimensionCalculator.javaect every time we need one.
   */
